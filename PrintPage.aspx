<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintPage.aspx.cs" Inherits="Student.PrintPage" %>
...
<body>
    <form id="form1" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style4">Class Code:</td>
            ...
            <tr>
                <td class="auto-style3">Joined On:</td>
                <td>
                    <asp:Label ID="joinLabel" runat="server"></asp:Label>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
